...
class UpdateJamatTime : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_update_jamat_time)
    ...
    private fun navigateToNextActivity() {
        val intent = Intent(this, Actually_Upadate_Jamat_Time::class.java)

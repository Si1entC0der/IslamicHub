...
class Actually_Upadate_Jamat_Time : AppCompatActivity() {
    private lateinit var back_btnUP : Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_actually_upadate_jamat_time)
        ...
        back_btnUP = findViewById(R.id.back_in_btn)
